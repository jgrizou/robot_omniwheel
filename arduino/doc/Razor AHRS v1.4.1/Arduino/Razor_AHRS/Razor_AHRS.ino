...
#define MAGN_X_MIN ((float) -446)
#define MAGN_X_MAX ((float) 584)
#define MAGN_Y_MIN ((float) -466)
#define MAGN_Y_MAX ((float) 556)
#define MAGN_Z_MIN ((float) -489)
#define MAGN_Z_MAX ((float) 398)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -18.57)
#define GYRO_AVERAGE_OFFSET_Y ((float) 65.24)
#define GYRO_AVERAGE_OFFSET_Z ((float) -14.28)
