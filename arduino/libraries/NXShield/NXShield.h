...
* NXShield.h defines main interfaces used in the NXShield library.
 ...
 Latest revision of this Library Reference is available at:
 http://nxshield.svn.sourceforge.net/viewvc/nxshield/NXShield/html/index.html
 (Note however, the latest revision is usually a work in progress, and may not match with the library files you have installed on your computer).
