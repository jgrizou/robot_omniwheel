  ...
  class NodeletLoadRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_remap_source_argsi = (uint32_t *)(outbuffer + offset);
      *length_remap_source_argsi = strlen( (const char*) this->remap_source_args[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_remap_target_argsi = (uint32_t *)(outbuffer + offset);
      *length_remap_target_argsi = strlen( (const char*) this->remap_target_args[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_my_argvi = (uint32_t *)(outbuffer + offset);
      *length_my_argvi = strlen( (const char*) this->my_argv[i]);
      offset += 4;
      memcpy(outbuffer + offset, this->my_argv[i], *length_my_argvi);
      offset += *length_my_argvi;
      }
      uint32_t * length_bond_id = (uint32_t *)(outbuffer + offset);
      *length_bond_id = strlen( (const char*) this->bond_id);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < remap_source_args_length; i++){
      uint32_t length_st_remap_source_args = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < remap_target_args_length; i++){
      uint32_t length_st_remap_target_args = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < my_argv_length; i++){
      uint32_t length_st_my_argv = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      uint32_t length_bond_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
