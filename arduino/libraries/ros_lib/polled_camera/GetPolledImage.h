...
static const char GETPOLLEDIMAGE[] = "polled_camera/GetPolledImage";
  ...
  class GetPolledImageRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_response_namespace = (uint32_t *)(outbuffer + offset);
      *length_response_namespace = strlen( (const char*) this->response_namespace);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_response_namespace = *(uint32_t *)(inbuffer + offset);
      offset += 4;
