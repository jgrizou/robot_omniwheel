  ...
  class Status : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_id = strlen( (const char*) this->id);
      ...
      offset += *length_id;
      uint32_t * length_instance_id = (uint32_t *)(outbuffer + offset);
      *length_instance_id = strlen( (const char*) this->instance_id);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_id;
      uint32_t length_instance_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
