  ...
  class SpawnModelRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_model_name = strlen( (const char*) this->model_name);
      ...
      uint32_t * length_model_xml = (uint32_t *)(outbuffer + offset);
      *length_model_xml = strlen( (const char*) this->model_xml);
      offset += 4;
      memcpy(outbuffer + offset, this->model_xml, *length_model_xml);
      offset += *length_model_xml;
      uint32_t * length_robot_namespace = (uint32_t *)(outbuffer + offset);
      *length_robot_namespace = strlen( (const char*) this->robot_namespace);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_model_name;
      uint32_t length_model_xml = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_model_xml;
      uint32_t length_robot_namespace = *(uint32_t *)(inbuffer + offset);
      offset += 4;
