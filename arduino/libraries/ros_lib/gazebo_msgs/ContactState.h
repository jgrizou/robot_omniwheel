  ...
  class ContactState : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_info = strlen( (const char*) this->info);
      ...
      offset += *length_info;
      uint32_t * length_collision1_name = (uint32_t *)(outbuffer + offset);
      *length_collision1_name = strlen( (const char*) this->collision1_name);
      offset += 4;
      memcpy(outbuffer + offset, this->collision1_name, *length_collision1_name);
      offset += *length_collision1_name;
      uint32_t * length_collision2_name = (uint32_t *)(outbuffer + offset);
      *length_collision2_name = strlen( (const char*) this->collision2_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_info;
      uint32_t length_collision1_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_collision1_name;
      uint32_t length_collision2_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
