  ...
  class SetModelConfigurationRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_model_name = strlen( (const char*) this->model_name);
      ...
      uint32_t * length_urdf_param_name = (uint32_t *)(outbuffer + offset);
      *length_urdf_param_name = strlen( (const char*) this->urdf_param_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_model_name;
      uint32_t length_urdf_param_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
