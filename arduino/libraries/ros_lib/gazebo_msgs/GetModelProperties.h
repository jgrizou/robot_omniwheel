...
static const char GETMODELPROPERTIES[] = "gazebo_msgs/GetModelProperties";
  ...
  class GetModelPropertiesResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_parent_model_name = (uint32_t *)(outbuffer + offset);
      *length_parent_model_name = strlen( (const char*) this->parent_model_name);
      offset += 4;
      memcpy(outbuffer + offset, this->parent_model_name, *length_parent_model_name);
      offset += *length_parent_model_name;
      uint32_t * length_canonical_body_name = (uint32_t *)(outbuffer + offset);
      *length_canonical_body_name = strlen( (const char*) this->canonical_body_name);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_body_namesi = (uint32_t *)(outbuffer + offset);
      *length_body_namesi = strlen( (const char*) this->body_names[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_geom_namesi = (uint32_t *)(outbuffer + offset);
      *length_geom_namesi = strlen( (const char*) this->geom_names[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_child_model_namesi = (uint32_t *)(outbuffer + offset);
      *length_child_model_namesi = strlen( (const char*) this->child_model_names[i]);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_parent_model_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_parent_model_name;
      uint32_t length_canonical_body_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < body_names_length; i++){
      uint32_t length_st_body_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < geom_names_length; i++){
      uint32_t length_st_geom_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < child_model_names_length; i++){
      uint32_t length_st_child_model_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
