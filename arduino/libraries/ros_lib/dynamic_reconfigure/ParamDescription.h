  ...
  class ParamDescription : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->level >> (8 * 3)) & 0xFF;
      ...
      uint32_t * length_description = (uint32_t *)(outbuffer + offset);
      *length_description = strlen( (const char*) this->description);
      offset += 4;
      memcpy(outbuffer + offset, this->description, *length_description);
      offset += *length_description;
      uint32_t * length_edit_method = (uint32_t *)(outbuffer + offset);
      *length_edit_method = strlen( (const char*) this->edit_method);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->level);
      uint32_t length_description = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_description;
      uint32_t length_edit_method = *(uint32_t *)(inbuffer + offset);
      offset += 4;
