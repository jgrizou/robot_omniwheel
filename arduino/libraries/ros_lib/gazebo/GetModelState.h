  ...
  class GetModelStateRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_model_name = strlen( (const char*) this->model_name);
      ...
      uint32_t * length_relative_entity_name = (uint32_t *)(outbuffer + offset);
      *length_relative_entity_name = strlen( (const char*) this->relative_entity_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_model_name;
      uint32_t length_relative_entity_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
