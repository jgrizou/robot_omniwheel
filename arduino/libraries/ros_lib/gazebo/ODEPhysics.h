#ifndef _ROS_gazebo_ODEPhysics_h
#define _ROS_gazebo_ODEPhysics_h
...
namespace gazebo
{
  ...
  class ODEPhysics : public ros::Msg
  {
    ...
    const char * getType(){ return "gazebo/ODEPhysics"; };
    const char * getMD5(){ return "cecbd7ae4dd73d0ce24e775cee96d4a6"; };
