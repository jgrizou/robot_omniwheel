...
static const char APPLYBODYWRENCH[] = "gazebo/ApplyBodyWrench";
  ...
  class ApplyBodyWrenchRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_body_name = (uint32_t *)(outbuffer + offset);
      *length_body_name = strlen( (const char*) this->body_name);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_body_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
