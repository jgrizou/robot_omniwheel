  ...
  class ContactState : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_info = strlen( (const char*) this->info);
      ...
      offset += *length_info;
      uint32_t * length_geom1_name = (uint32_t *)(outbuffer + offset);
      *length_geom1_name = strlen( (const char*) this->geom1_name);
      offset += 4;
      memcpy(outbuffer + offset, this->geom1_name, *length_geom1_name);
      offset += *length_geom1_name;
      uint32_t * length_geom2_name = (uint32_t *)(outbuffer + offset);
      *length_geom2_name = strlen( (const char*) this->geom2_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_info;
      uint32_t length_geom1_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_geom1_name;
      uint32_t length_geom2_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
