...
namespace visualization_msgs
{
  ...
  class Marker : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_ns = (uint32_t *)(outbuffer + offset);
      *length_ns = strlen( (const char*) this->ns);
      offset += 4;
      ...
      *length_text = strlen( (const char*) this->text);
      ...
      offset += *length_text;
      uint32_t * length_mesh_resource = (uint32_t *)(outbuffer + offset);
      *length_mesh_resource = strlen( (const char*) this->mesh_resource);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_ns = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_text;
      uint32_t length_mesh_resource = *(uint32_t *)(inbuffer + offset);
      offset += 4;
