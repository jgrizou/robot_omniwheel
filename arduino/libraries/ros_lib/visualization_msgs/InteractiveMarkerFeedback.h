...
namespace visualization_msgs
{
  ...
  class InteractiveMarkerFeedback : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_client_id = (uint32_t *)(outbuffer + offset);
      *length_client_id = strlen( (const char*) this->client_id);
      offset += 4;
      memcpy(outbuffer + offset, this->client_id, *length_client_id);
      offset += *length_client_id;
      uint32_t * length_marker_name = (uint32_t *)(outbuffer + offset);
      *length_marker_name = strlen( (const char*) this->marker_name);
      offset += 4;
      memcpy(outbuffer + offset, this->marker_name, *length_marker_name);
      offset += *length_marker_name;
      uint32_t * length_control_name = (uint32_t *)(outbuffer + offset);
      *length_control_name = strlen( (const char*) this->control_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_client_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_client_id;
      uint32_t length_marker_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_marker_name;
      uint32_t length_control_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
