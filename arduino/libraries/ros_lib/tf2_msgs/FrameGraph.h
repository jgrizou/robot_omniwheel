...
static const char FRAMEGRAPH[] = "tf2_msgs/FrameGraph";
  ...
  class FrameGraphResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_frame_yaml = (uint32_t *)(outbuffer + offset);
      *length_frame_yaml = strlen( (const char*) this->frame_yaml);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_frame_yaml = *(uint32_t *)(inbuffer + offset);
      offset += 4;
