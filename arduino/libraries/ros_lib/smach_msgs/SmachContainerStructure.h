...
namespace smach_msgs
{
  ...
  class SmachContainerStructure : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_path = (uint32_t *)(outbuffer + offset);
      *length_path = strlen( (const char*) this->path);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_childreni = (uint32_t *)(outbuffer + offset);
      *length_childreni = strlen( (const char*) this->children[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_internal_outcomesi = (uint32_t *)(outbuffer + offset);
      *length_internal_outcomesi = strlen( (const char*) this->internal_outcomes[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_outcomes_fromi = (uint32_t *)(outbuffer + offset);
      *length_outcomes_fromi = strlen( (const char*) this->outcomes_from[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_outcomes_toi = (uint32_t *)(outbuffer + offset);
      *length_outcomes_toi = strlen( (const char*) this->outcomes_to[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_container_outcomesi = (uint32_t *)(outbuffer + offset);
      *length_container_outcomesi = strlen( (const char*) this->container_outcomes[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_path = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < children_length; i++){
      uint32_t length_st_children = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < internal_outcomes_length; i++){
      uint32_t length_st_internal_outcomes = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < outcomes_from_length; i++){
      uint32_t length_st_outcomes_from = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < outcomes_to_length; i++){
      uint32_t length_st_outcomes_to = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < container_outcomes_length; i++){
      uint32_t length_st_container_outcomes = *(uint32_t *)(inbuffer + offset);
      offset += 4;
