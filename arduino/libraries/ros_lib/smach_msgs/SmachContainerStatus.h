  ...
  class SmachContainerStatus : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_initial_statesi = (uint32_t *)(outbuffer + offset);
      *length_initial_statesi = strlen( (const char*) this->initial_states[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_active_statesi = (uint32_t *)(outbuffer + offset);
      *length_active_statesi = strlen( (const char*) this->active_states[i]);
      offset += 4;
      memcpy(outbuffer + offset, this->active_states[i], *length_active_statesi);
      offset += *length_active_statesi;
      }
      uint32_t * length_local_data = (uint32_t *)(outbuffer + offset);
      *length_local_data = strlen( (const char*) this->local_data);
      offset += 4;
      memcpy(outbuffer + offset, this->local_data, *length_local_data);
      offset += *length_local_data;
      uint32_t * length_info = (uint32_t *)(outbuffer + offset);
      *length_info = strlen( (const char*) this->info);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < initial_states_length; i++){
      uint32_t length_st_initial_states = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < active_states_length; i++){
      uint32_t length_st_active_states = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      uint32_t length_local_data = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_local_data;
      uint32_t length_info = *(uint32_t *)(inbuffer + offset);
      offset += 4;
