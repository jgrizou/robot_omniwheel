...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/jgrizou/workspace/code/lego/catkin_ws/src/rosserial/rosserial_client/${idir})
      set(include /home/jgrizou/workspace/code/lego/catkin_ws/src/rosserial/rosserial_client/${idir})
    else()
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jgrizou/workspace/code/lego/catkin_ws/src/rosserial/rosserial_client/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@willowgarage.com>' to fix it.")
    endif()
